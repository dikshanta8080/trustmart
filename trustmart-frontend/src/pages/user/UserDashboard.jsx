...
const MOCK_USER = {
name: 'Nisha Acharya',
email: '[nisha@example.com](mailto:nisha@example.com)',
...
return ( <div className="space-y-6 pb-8"> <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4"> <div> <h1 className="text-2xl font-bold text-gray-900">
Dashboard </h1>
